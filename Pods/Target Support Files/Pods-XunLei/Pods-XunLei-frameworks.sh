...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/../../flutter_moduleexcise/.ios/Flutter/engine/Flutter.framework"
  ...
  install_framework "${PODS_ROOT}/../../flutter_moduleexcise/.ios/Flutter/App.framework"
fi
